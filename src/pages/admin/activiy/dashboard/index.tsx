...
const LQdata = {
  교육활동: [
    { name: "교육외의 교육 활동", value: 15, id: 1 },
    { name: "교육 조교 활동", value: 25, id: 2 },
  ],
  "교육 성취도": [
    { name: "학점 4.0~4.5", value: 18, id: 3 },
    { name: "학점 3.5~4.0", value: 12, id: 4 },
    { name: "학점 3.0~3.5", value: 22, id: 5 },
  ],
  "오픈소스 SW 활동": [
    { name: "OS 커뮤니티 생성 및 활성도 5점", value: 14, id: 6 },
    { name: "OS 커뮤니티 참여 및 활성도 4점", value: 28, id: 7 },
    { name: "OS 커뮤니티 참여 및 활성도 3점", value: 35, id: 8 },
    { name: "커미터로서의 활동 5점", value: 47, id: 9 },
    { name: "커미터로서의 활동 4점", value: 32, id: 10 },
    { name: "커미터로서의 활동 3점", value: 53, id: 11 },
  ],
};

const RQdata = {
  "학술지 논문게재": [
    { name: "SCI, SSCI, A&HCI 급 학술지", value: 12, id: 12 },
    { name: "KCI 우수등재 학술지", value: 8, id: 13 },
    { name: "KCI 등재", value: 6, id: 14 },
    { name: "KCI 후보, 기타국제", value: 4, id: 15 },
  ],
  "학술대회 발표": [
    { name: "저명 국제학술대회 발표", value: 13, id: 16 },
    { name: "저명 국제학술대회 발표(BK기준 4점)", value: 7, id: 17 },
    { name: "일반 국제학술대회 발표", value: 5, id: 18 },
    { name: "국내학술대회 발표", value: 3, id: 19 },
  ],
  "공모전/ICPC": [
    { name: "국제/대규모 공모전(대상/입상)", value: 15, id: 20 },
    { name: "국제/대규모 공모전(참여)", value: 4, id: 21 },
    { name: "교내/지역 공모전(대상/입상)", value: 6, id: 22 },
    { name: "교내/지역 공모전(참여)", value: 1.5, id: 23 },
  ],
};

const CQdata = {
  산학프로젝트: [
    { name: "수행여부", value: 4, id: 24 },
    { name: "평가점수 A", value: 7, id: 25 },
    { name: "평가점수 B", value: 5, id: 26 },
    { name: "평가점수 C", value: 2, id: 27 },
  ],
  인턴십: [
    { name: "수행여부", value: 3, id: 28 },
    { name: "평가점수 A", value: 8, id: 29 },
    { name: "평가점수 B", value: 6, id: 30 },
    { name: "평가점수 C", value: 2, id: 31 },
  ],
  창업: [{ name: "수행여부", value: 25, id: 32 }],
  해외봉사: [
    { name: "수행여부", value: 12, id: 33 },
    { name: "평가점수 A", value: 8, id: 34 },
    { name: "평가점수 B", value: 5, id: 35 },
    { name: "평가점수 C", value: 3, id: 36 },
  ],
  "화상강연/세미나 참여": [{ name: "수행여부", value: 2, id: 37 }],
  알리미: [
    { name: "회장", value: 8, id: 38 },
    { name: "부회장", value: 12, id: 39 },
    { name: "임원진", value: 7, id: 40 },
    { name: "참여", value: 3, id: 41 },
  ],
  학생회: [
    { name: "회장", value: 5, id: 42 },
    { name: "부회장", value: 10, id: 43 },
    { name: "임원진", value: 7, id: 44 },
    { name: "참여", value: 3, id: 45 },
  ],
  SCG: [
    { name: "회장", value: 15, id: 46 },
    { name: "부회장", value: 10, id: 47 },
    { name: "임원진", value: 7, id: 48 },
    { name: "참여", value: 4, id: 49 },
  ],
  미디어홍보: [
    { name: "회장", value: 12, id: 50 },
    { name: "부회장", value: 9, id: 51 },
    { name: "임원진", value: 5, id: 52 },
    { name: "참여", value: 3, id: 53 },
  ],
  스튜디오기여: [{ name: "참여", value: 4, id: 54 }],
  스터디그룹: [
    { name: "회장", value: 7, id: 55 },
    { name: "부회장", value: 10, id: 56 },
    { name: "참여", value: 3, id: 57 },
  ],
};
        ...
        <GraphWrapper
          ...
          options={{
            ...
            datasets: {
              ...
              SCG: <SimpleChart data={populatedCQdata["SCG"]} />,
              미디어홍보: <SimpleChart data={populatedCQdata["미디어홍보"]} />,
              "스튜디오 기여": (
